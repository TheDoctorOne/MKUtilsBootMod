...
public class NettyPacketDecoder extends net.minecraft.network.NettyPacketDecoder {
    ...
    private final CPacketLoginStart cPacketLoginStart =  new CPacketLoginStart();
    ...
    protected void decode(ChannelHandlerContext p_decode_1_, ByteBuf p_decode_2_, List<Object> p_decode_3_) throws IOException, InstantiationException, IllegalAccessException, Exception
    {
        if (p_decode_2_.readableBytes() != 0)
        {
            ...
            {
                if(packet instanceof net.minecraft.network.login.client.CPacketLoginStart) {
                    packet = cPacketLoginStart;
                }
